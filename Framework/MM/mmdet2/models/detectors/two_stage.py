...
class TwoStageDetector(BaseDetector):
    ...
    def forward_train(self,
        ...
        # ======================== Forward ========================
        # x = self.extract_feat(img)
        # rpn_losses, proposal_list = self.rpn_head.forward_train(x, gt_bboxes, gt_labels, ...)
        # roi_losses = self.roi_head.forward_train(x, proposal_list, gt_bboxes, gt_labels, ...)
        #
        # losses: dict(**rpn_losses, **roi_losses)
        # Return losses
        # ======================================================
        ...
        roi_losses = self.roi_head.forward_train(x, img_metas, proposal_list, gt_bboxes, gt_labels, gt_bboxes_ignore,
                                                 gt_masks, **kwargs)
