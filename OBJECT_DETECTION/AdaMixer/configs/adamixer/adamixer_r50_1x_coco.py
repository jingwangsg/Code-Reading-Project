...
model = dict(
    ...
    rpn_head=dict(type="InitialQueryGenerator", num_query=num_query, content_dim=QUERY_DIM),
    roi_head=dict(
...
# learning policy
lr_config = dict(policy="step", step=[8, 11], warmup="linear", warmup_iters=500, warmup_ratio=0.001)
