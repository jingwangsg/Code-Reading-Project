...
class Transformer(nn.Module):
    ...
    def forward(self,
        ...
        hs, outputs_coord = self.decoder(tgt,
                                         memory,
...
class TransformerDecoder(nn.Module):
    ...
    def pred_with_init_reference(cls, tmp, reference_points_before_sigmoid):
        ...
        args:
            ...
            reference_points_before_sigmoid: initial offset predicted by self.ref_point_head
                1. given dimension-2 logits, tmp[..., :2] += reference_points_before_sigmoid
                2. given dimension-4 logits, tmp[..., :] += reference_points_before_sigmoid
        return:
            updated prediction
    ...
    def forward(
        ...
        for lid, layer in enumerate(self.layers):
            ...
            """<START> box refine
            iteratively refine reference points
            feature (output_norm) and bbox proposal (coord_norm) are recorded in intermediate, intermediate_references
            reference_points_before_sigmoid is generated by self.ref_point_head(query_pos)

            * tmp here refers to offset
            """
            ...
            if not self.box_refine:
                ...
                if lid == 0:
                    ...
                    # if not at first stage, box refine
