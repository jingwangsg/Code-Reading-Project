...
from mmdet.models.builder import build_detector, build_head, build_backbone, build_neck


def __test_admixer__():
    num_stages = 6
    num_proposals = 100
    QUERY_DIM = 256
    FEAT_DIM = 256
    ...
    det_cfg = dict(
        ...
        rpn_head=dict(type="InitialQueryGenerator", num_query=num_proposals, content_dim=QUERY_DIM),
        roi_head=dict(
